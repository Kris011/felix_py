...
""")
file = """<h1>Bienvenido a Felix py</h1><br><h3>!Si quieres tu servidor modifica el archivo main.py en la linea 16 donde dice file</h3><br><li>Gracias</li><a href="https://github.com/Kris011">Apoyame en mi github</a>
"""
app = Flask(__name__)
@app.route("/")
def server():
